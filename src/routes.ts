...
routes.put(
  ...
  ensuredAuthenticated(),
  ensuredValidateUUID(),
  new UpdateInformationsUserController().handle
);
routes.delete(
  "/users/:id",
  ensuredAuthenticated(),
...
routes.get(
  ...
  ensuredAuthenticated(),
  can(["admin", "expenses"]),
  new GetAllExpensesController().handle
);
routes.put(
  "/expenses/:id",
  ensuredAuthenticated(),
...
routes.post(
  ...
  can(["admin"]),
  new CreateAdministratorController().handle
);
routes.put(
  "/update_admin/:id",
  ensuredAuthenticated(),
  ...
  can(["admin"]),
  ensuredValidateUUID(),
  new UpdateAdministratorController().handle
);
routes.get(
  "/get_admin",
  ensuredAuthenticated(),
  can(["admin"]),
  new GetAdministratorController().handle
);
...
routes.get(
  ...
  ensuredAuthenticated(),
  can(["admin", "customers"]),
  new GetAllCustomersController().handle
);
...
routes.post(
  ...
  ensuredAuthenticated(),
  can(["admin", "sales"]),
  new CreateSaleProductsSoldController().handle
);
routes.get(
  "/sales",
  ensuredAuthenticated(),
  can(["admin", "sales"]),
  new GettAllSaleProductsController().handle
);
routes.delete(
  "/sales/:id",
  ensuredAuthenticated(),
  can(["admin", "sales"]),
  ensuredValidateUUID(),
  new DeleteSaleProductsController().handle
);
routes.put(
  "/sales/:id",
  ensuredAuthenticated(),
  can(["admin", "sales"]),
  ensuredValidateUUID(),
  new UpdateSaleProductsController().handle
);
...
routes.get(
  ...
  can(["admin", "reports"]),
  ensuredValidateUUID(),
  new GetSalesOrderController().handle
);
